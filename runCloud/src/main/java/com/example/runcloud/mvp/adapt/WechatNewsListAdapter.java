 ...
 */
public class WechatNewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<WechatData> getList() {
        return list;
    }

    public WechatNewsListAdapter(OnListFragmentInteract listener, BaseActivity activity, int newsType) {
        mListener = listener;
        mRealm = activity.mRealm;
        list = DB.findAll(mRealm, WechatData.class);
    }
