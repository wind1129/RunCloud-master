...
public class SearchNewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchNewsListAdapter(OnListFragmentInteract listener, BaseActivity activity, int newsType) {
        mListener = listener;
        mRealm = activity.mRealm;
        list = DB.findAll(mRealm, SearchData.class);
    }
