 ...
 */
public class AbroadNewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<AbroadData> list;
    ...
    public List<AbroadData> getList() {
        return list;
    }

    public AbroadNewsListAdapter(OnListFragmentInteract listener, BaseActivity activity, int newsType) {
        mListener = listener;
        mRealm = activity.mRealm;
        list = DB.findAll(mRealm, AbroadData.class);
    }
