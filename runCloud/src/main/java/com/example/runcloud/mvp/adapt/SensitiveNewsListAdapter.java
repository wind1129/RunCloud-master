 ...
 */
public class SensitiveNewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SensitiveNewsListAdapter(OnListFragmentInteract listener, BaseActivity activity, int newsType) {
        mListener = listener;
        mRealm = activity.mRealm;
        list = DB.findAll(mRealm, DataList.class);
    }
