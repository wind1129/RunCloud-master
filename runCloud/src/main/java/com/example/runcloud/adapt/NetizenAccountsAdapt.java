...
public class NetizenAccountsAdapt extends BaseAdapter{
	private List<NetizenShowBasic> conditions;
	private Context context; 
	
	 public NetizenAccountsAdapt(Context context, List<NetizenShowBasic> conditions) {
	        super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context, R.layout.query_items1, null);
