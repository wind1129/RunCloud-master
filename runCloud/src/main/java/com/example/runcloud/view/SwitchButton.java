...
public class SwitchButton extends RadioGroup implements OnCheckedChangeListener {
	...
	/** 默认选项卡数量 */
	private final static int DEFAULT_SWITCH_COUNT = 1;
	...
	public CharSequence[] getmTexts() {
		return mTexts;
	}

	public void setmTexts(CharSequence[] mTexts) {
		this.mTexts = mTexts;
	}
	...
	public void setSwitchCount(int switchCount) {
		this.switchCount = switchCount < 1 ? DEFAULT_SWITCH_COUNT : switchCount;
