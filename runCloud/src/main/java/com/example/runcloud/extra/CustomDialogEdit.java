...
public class CustomDialogEdit extends Dialog {
	...
	public CustomDialogEdit(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CustomDialogEdit create() {
			...
			final CustomDialogEdit dialog = new CustomDialogEdit(context,R.style.Dialog);
			...
			if (message != null&& message.equals("start")) {
				...
				((LinearLayout) layout.findViewById(R.id.content)).addView(
						contentView, new LayoutParams(
								...
								LayoutParams.FILL_PARENT));
			}else if(message != null&& !message.equals("start")){
				((TextView) layout.findViewById(R.id.message)).setVisibility(View.GONE);
				((EditText) layout.findViewById(R.id.edit_message)).setVisibility(View.VISIBLE);
