...
public class DB {
    ...
    public static <T extends RealmObject> T getById(Realm realm, String id, Class<T> realmObjectClass) {
        return realm.where(realmObjectClass).equalTo("docId", id).findFirst();
    }
