...
import com.example.runcloud.mvp.presenter.PushDetailPresenter;
 ...
 */
public class PushDetailFragment extends Fragment implements PushDetailContract.View, View.OnClickListener {
    public static final String TAG = PushDetailFragment.class.getSimpleName();
    ...
    private PushData mStory;

    private PushDetailContract.Presenter presenter;
    private String docID;
    private String keyWords;
    private String uri;
    private String uriPart = "/ares/restful/push/detail?userId=1&pushId=";
    private String url;
    private String star_uriPart ="/ares/restful/push/likeDoc";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new PushDetailPresenter(this);
        ...
        url = uri + uriPart+docID;
        star_url = uri + star_uriPart;
        //Log.d("url+++",url);
        ...
        iv_star = (ImageView) getActivity().findViewById(R.id.iv_star);
        iv_star.setOnClickListener(this);
    }


    @Override
    public void showStarMessage(String message) {
        FunctionUtils.showCustomDialog(message, getActivity());
    }

    /*view接口*/
    @Override
    public void showStory(final PushData story) {
    ...
    /*普通逻辑*/
    public static PushDetailFragment newInstance(String docID, String keyWords) {
        PushDetailFragment fragment = new PushDetailFragment();
    ...
    private void bindData(PushData story) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_star:
                Log.d("111111","点我了");
                presenter.pushStar(star_url,userId,orgId,mStory.getPushId());
                break;
